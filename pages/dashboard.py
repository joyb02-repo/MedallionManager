...
<style>
    ...
    /* TARGET EVERY RELEVANT DOM WRAPPER GENERATED BY STREAMLIT BY KEY ATTR */
    div[data-testid="stElementContainer"]:has(button[key="sys_refresh_btn"]),
    div[data-testid="stElementContainer"]:has(button[key="sys_route_store_btn"]),
